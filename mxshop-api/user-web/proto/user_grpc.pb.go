...
const (
	...
	User_CreteUser_FullMethodName       = "/User/CreteUser"
...
type UserClient interface {
	...
	// 注册用户
	CreteUser(ctx context.Context, in *CreateUserInfo, opts ...grpc.CallOption) (*UserInfoResponse, error)
	// 更新用户
...
func (c *userClient) CreteUser(ctx context.Context, in *CreateUserInfo, opts ...grpc.CallOption) (*UserInfoResponse, error) {
	out := new(UserInfoResponse)
	err := c.cc.Invoke(ctx, User_CreteUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	// 注册用户
	CreteUser(context.Context, *CreateUserInfo) (*UserInfoResponse, error)
	// 更新用户
...
func (UnimplementedUserServer) CreteUser(context.Context, *CreateUserInfo) (*UserInfoResponse, error) {
...
func _User_CreteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_CreteUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).CreteUser(ctx, req.(*CreateUserInfo))
	}
	return interceptor(ctx, in, info, handler)
}
